...
<div class="insertdata">         
 ...
 <form action="salaryInsertServlet" method="post">
 
    <label for="employeeid">Employee ID:</label><br>
    <input type="text" id="employeeid" name="employeeid" class="input"  required><br><br>

    <label for="basic">Base Salary:</label><br>
    <input type="number" id="basic" name="basic" class="input" required><br><br>

    <label for="bonus">Bonus:</label><br>
    <input type="number" id="bonus" name="bonus" class="input" required><br><br>

    <label for="paydate">Pay Date:</label><br>
    <input type="date" id="paydate" name="paydate" class="input" required><br><br>
