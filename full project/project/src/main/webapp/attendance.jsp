...
<a href= "attendanceinsert.jsp"> <button class="addbtn">mark attendance</button></a><br><br>
</div>
<div class="showdetails" >
	...
	<table>  <tr>
     ...
     <c:forEach var = "attend" items = "${attend}"> 
     <tr>
...
<td> <a href= "updateAttendance.jsp?attendanceid=${attend.attendanceid}&employeeid=${attend.employeeid}&date=${attend.date}&checkintime=${attend.checkintime}&leavetime=${attend.leavetime}"> <button class="btnUpdate">Update</button></a></td>
   
      <td>
        <form action="DeleteAttendanceServlet" method="post">
        <input type="hidden" name="attendanceid"  value="${attend.attendanceid}" />
