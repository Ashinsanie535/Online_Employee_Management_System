...
<div class="insertdata">
 ...
 <form action="UpdateSalaryServlet" method="post">
    ...
    <label for="salaryid">Salary ID:</label><br>
    <input type="number" id="salaryid" name="salaryid" class="input" value ="<%=salaryid%>" readonly><br><br>
 
    <label for="employeeid">Employee ID:</label><br>
    <input type="text" id="employeeid" name="employeeid" class="input" value ="<%=employeeid%>" required><br><br>

    <label for="basic">Base Salary:</label><br>
    <input type="number" id="basic" name="basic" class="input" value ="<%=basic%>" required><br><br>

    <label for="bonus">Bonus:</label><br>
    <input type="number" id="bonus" name="bonus" class="input" value ="<%=bonus%>" required><br><br>


    <label for="paydate">Pay Date:</label><br>
    <input type="date" id="paydate" name="paydate" class="input" value ="<%=paydate%>" required><br><br>

    <input type="submit" class="btn" value="Submit Salary">
  </form>
</div>
