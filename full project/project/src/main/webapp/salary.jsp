...
<a href= "salaryinsert.jsp"> <button class="addbtn">add salary</button></a><br><br>
...
<div class="showdetails">
	<table>  <tr>
     ...
     <c:forEach var = "salaries" items = "${salaries}"> 
     <tr>
        <td> ${salaries.salaryid} </td>
        <td> ${salaries.employeeid} </td>
        <td>Rs: ${salaries.basic}/= </td>
        <td>Rs: ${salaries.bonus}/= </td>
        <td>Rs: ${salaries.salary}/= </td>
        <td> ${salaries.paydate} </td>
        
        
        
<td> <a href= "updatesalary.jsp?salaryid=${salaries.salaryid}&employeeid=${salaries.employeeid}&basic=${salaries.basic}&bonus=${salaries.bonus}&salary=${salaries.salary}&paydate=${salaries.paydate}"> <button class="btnUpdate">Update</button></a></td>
 
      <td>
        <form action="DeleteSalaryServlet" method="post">
        <input type="hidden" name="salaryid"  value="${salaries.salaryid}" />
