...
<div class="insertdata">
    ...
    <form action="InsertAttendanceServlet" method="post">
        ...
        <input type="text" id="employeeid"  class="input" name="employeeid" required><br><br>

        <label for="date">Date:</label><br>
        <input type="date" id="date"  class="input" name="date" required><br><br>

        <label for="checkintime">Check-In Time:</label>
        <input type="time" id="checkintime"  class="input" name="checkintime" required><br><br>

        <label for="leavetime">Leave Time:</label><br>
        <input type="time" id="leavetime" class="input" name="leavetime"><br><br>
