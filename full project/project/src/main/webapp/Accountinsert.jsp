...
<div class="Cname"> <h1>CEYLON CROWN TEA</h1><h2> Welcome To Human Resources Department</h2></div>
...
<!--.............................mainBody................................-->
    ...
    <form method = "post" action = "insertAccounts">
      ...
      <input type="tel" id="phone" name = "phone" placeholder="Enter Employee Phone" />
      
       <label for="mail">E-mail</label>
      <input type="email" id="mail" name = "email" placeholder="Enter Employee mail" /><br>

      <br><label for="date">Join Date</label>
      <input type="date"  name = "joindate" placeholder="Enter Join Date"/> <br>
      ...
      <select id="department"  name = "department" onchange="updateDesignations()">
        ...
        <option value="Research and Development (R and D)">Research and Development (R and D)</option>
      ...
      <input type="password"  name = "password" placeholder="Enter Join Password"/> <br>
